...
description: '大多數人在「使用」AI，極少數人在「建構」以 AI 為核心的工作系統。這篇是系列起點：一個中醫診所院長兼自媒體創作者，從一次性對話走向 AI 工作流的真實轉折，以及一個非工程師可以怎麼開始。'
pubDate: '2026-05-30'
pillar: 'AI 工作流'
tags: ['AI工作流', 'AI工作系統', 'AI生產力', '起點']
---

我不是 AI 工程師，也不是提示詞達人。我是一個開中醫診所、同時做 YouTube 和 Podcast 的人。我會開始認真建一套以 AI 為核心的工作系統，原因很簡單：我受夠了每次都從頭開始。
...
半年前，我每天的用法是這樣：遇到一個診所經營的問題、一個內容企劃的卡關、一個要不要投資某個設備的決定，我就打開一個新對話，先花五分鐘解釋我是誰、診所多大、團隊幾個人、我現在在煩惱什麼，然後才問問題。問完，得到一個還算可以的答案，關掉。

隔天，類似的問題又來了。我又開一個新對話，又從「我是一個開中醫診所的人……」開始講一次。

我用了它幾百次，但它對我的理解，永遠停在第一句話。每一次都是第一次。這就是把 AI 當免洗餐具——用完即丟，下次重買。當時我以為這就是 AI 的極限，直到我意識到，問題不在 AI，在我使用它的方式。
...
- **角色**：不是每次「問 AI 問題」，而是先「啟動對的顧問」——讓它用財務、人事、或內容的視角回答你。
...
我不會寫程式，我的本業是看診和做內容。我用的工具確實比一般對話介面多一點——我用的是 Claude Code，它能連接我的工作環境、讀檔案、有版本控制，這讓「管理 AI 的記憶」變成一件做得到的事。但你不需要從這裡開始。
