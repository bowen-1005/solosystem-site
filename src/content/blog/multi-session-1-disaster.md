---
title: '我把 AI 開成一支團隊，然後親手刪掉了自己的工作（多 session 工作法 1/4）'
description: '能同時指揮好幾個 AI 一起做事，是我心中「把 AI 用到底」的樣子。直到那天，這份力量親手刪掉了我半天的工作。多 session 工作法事故全紀錄第一篇：戰場、慾望，與一場連環爆——為什麼災難從來不是單一大錯。'
pubDate: '2026-06-03T00:00:00+08:00'
pillar: 'AI 工作流'
chapter: '多 session 工作法'
chapterNum: 7
episode: 24
tags: ['AI工作流', 'ClaudeCode', '多 session', 'AI記憶', '工作系統']
---
...
這個系列，記錄這套「多開 session」的工作方式怎麼引爆一場事故，我又怎麼把它重建成一套不會再互相覆蓋的系統——一個你能照著做的版本。故事是真的，但會指認到我個人與事業的細節都抽掉了：重點不是我是誰，是這套方法你能不能搬走。第一篇，先講事故怎麼發生。
...
A：單人單工時它沒問題。危險發生在「多隻手同時動同一個資料夾」時——它會把不屬於你、別人還沒處理完的變更也一起打包。多開 session 工作的第一條鐵律就是：只加自己負責的路徑，永遠不要 `git add -A`。
...
下一篇：[東西其實沒不見——但我的第一版解法，也是錯的](/blog/multi-session-2-recovery/)
