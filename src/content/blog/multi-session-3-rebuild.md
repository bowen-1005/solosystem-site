---
title: '我給 AI 裝上三個會吵架的腦袋，然後一步步重建（多 session 工作法 3/4）'
description: '走出事故的轉折不是某個聰明技術，是改變「怎麼跟 AI 一起想」：給它裝上會彼此反駁、不准投票了事的三個角色，加一套刻意練習的思考習慣。接著用八個里程碑，重建一套多開 session 不互相覆蓋的工作系統。'
...
> 上一篇：[東西其實沒不見——但我的第一版解法，也是錯的](/blog/multi-session-2-recovery/)。五個看似合理的錯被攤開之後，問題還在：怎麼走出來？
...
下一篇：[最終的系統、七條可搬走的原則，和一個誠實的尾聲](/blog/multi-session-4-system/)

← 回上一篇：[東西其實沒不見——但我的第一版解法，也是錯的](/blog/multi-session-2-recovery/)
