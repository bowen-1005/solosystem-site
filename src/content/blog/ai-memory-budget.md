...
**這個系列的上下篇**：上一篇〈[讓 AI 記住「你怎麼工作」](/blog/ai-memory-preferences/)〉講最值錢的偏好層，本篇講容量現實——記憶篇到此補滿。下一章進入角色篇，EP05：[不是問 AI，是啟動顧問](/blog/activate-advisor-not-ask/)——為什麼「問 AI 之前，先決定問誰」。

*延伸閱讀：[認知負荷理論（Cognitive Load Theory, Sweller）——工作記憶容量有限 (Wikipedia)](https://en.wikipedia.org/wiki/Cognitive_load)　｜　[近藤麻理惠 KonMari 整理法（官網）](https://konmari.com/)*
